...
$(document).ready(function() {
    ...
    const searchData = [
        ...
        },
        {
            ...
            url: "Section_logs.php"
        },      
        {
            title: "Absent Reports",
            keywords: ["absent", "reports", "verify", "approved reports", "pending reports", "top absentees", "view absences", "submit report"],
            url: "AbsentReports.php"
        }      
