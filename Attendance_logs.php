...
require_once 'config.php'; // $conn is PDO PostgreSQL
...
if (isset($_GET['export'])) {
    ...
    if (!empty($filters['year_section'])) {
        $query .= " AND s.year_section = :year_section";
        $params[':year_section'] = $filters['year_section'];
    }
...
// Get distinct year sections for filter dropdown
$year_sections = [];
$stmt = $conn->query("SELECT DISTINCT year_section FROM student_tbl ORDER BY year_section");
$year_sections = $stmt->fetchAll(PDO::FETCH_COLUMN);
...
// Year & section filter
if (!empty($filters['year_section'])) {
    $where .= " AND s.year_section = :year_section";
    $params[':year_section'] = $filters['year_section'];
}
                                ...
                                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAttendance" aria-expanded="true" aria-controls="collapsePages"> 
                                  ...
                                  <div id="collapseAttendance" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                                     <div class="bg-white py-2 collapse-inner rounded">
                                      <a class="collapse-item active" href="Attendance_logs.php">Attendance Logs</a> 
            ...
            <div class="card shadow" style="border-top: 8px solid #4169E1; border-radius: 1rem;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                        ...
                        <div class="d-flex">
                            <form method="GET" action="attendance_logs.php" id="exportForm">
                                <div class="btn-group">
                    ...
                    <div class="filter-container">                               
                        <form method="GET" action="attendance_logs.php" id="filterForm">
                            ...
                            <div class="filter-row">
                                ...
                                <div class="filter-group">
                                    ...
                                    <select name="year_section" class="form-control form-control-sm">
                                        <option value="">All</option>
                                        <?php foreach ($year_sections as $section): ?>
                                            <option value="<?= htmlspecialchars($section) ?>" <?= (isset($_GET['year_section']) && $_GET['year_section'] === $section) ? 'selected' : '' ?>>
        ...
        <div class="input-group-append">
            <button class="btn btn-primary btn-sm" type="submit">
                <i class="fas fa-search"></i>
                    ...
                    <p style="background-color: rgba(0, 123, 255, 0.1); color: #0056b3; padding: 10px 15px; border-radius: 6px; font-weight: 500; font-size: 13px;">
